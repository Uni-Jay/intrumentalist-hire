  ...
  const handleSubmit = async (e) => {
    ...
    if(Object.keys(formErrors).length === 0){
        ...
        try {
            ...
            const clientResopnse = await instance.put(`/api/client/${id}`, formDataClient);
...
const validateForm = () => {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
        ...
        <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white flex justify-center">Update Booking</h2>
            <form action="#">
